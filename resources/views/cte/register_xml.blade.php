						...
						<div class="row">
							<div class="col-sm-12 col-lg-12 col-md-12 col-xl-12">
								...
								<div class="row">
									...
									<div class="form-group validated col-sm-3 col-lg-3 col-12">
										<label class="col-form-label" id="">Situação Tributária</label>
										<select class="custom-select form-control"  style="width: 100%" id="cst" name="CST">
											@foreach($listaCST as $key => $c)
											<option value="{{$key}}" @if($config !=null) @if(isset($cte)) @if($key==$cte->CST)
												selected
												@endif
												@else
