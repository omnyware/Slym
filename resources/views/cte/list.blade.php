										...
										<div class="row">
																	...
																	<div class="row">
																		<span style="width: 280px;">
																			...
																			@if($c->estado == 'DISPONIVEL' || $c->estado == 'REJEITADO')
																				...
																				<a class="btn btn-danger" onclick='swal("Atenção!", "Deseja remover este registro?", "warning").then((sim) => {if(sim){ location.href="/cte/delete/{{ $c->id }}" }else{return false} })' title="Excluir CT-e" href="#!">
																					<i class="la la-trash"></i>				
																				</a>

																				<a class="btn btn-primary" onclick='swal("Atenção!", "Deseja editar este registro?", "warning").then((sim) => {if(sim){ location.href="/cte/edit/{{ $c->id }}" }else{return false} })' title="Editar CT-e" href="#!">
																					<i class="la la-edit"></i>	
																				</a>
																			@endif

																			<a class="btn btn-info" title="Detalhar CT-e" href="/cte/detalhar/{{ $c->id }}">
																				<i class="la la-file"></i>
																			</a>

																			<a class="btn btn-warning" title="Custos" href="/cte/custos/{{ $c->id }}">
											...
											<div class="col-sm-12 col-lg-12 col-md-12 col-xl-12">
												...
												<div class="row" style="margin-top: 5px;">
													...
													<div class="col-sm-4 col-lg-4 col-md-4 col-xl-2 col-6">
														<a id="btn-imprimir-cancelar" onclick="xmlTemp()" style="width: 100%" class="btn btn-secondary" href="#!">Xml temporário</a>
													</div>
												</div>
											</div>
											@else
