															...
															<div class="row align-items-center">
																...
																<div class="form-group validated col-sm-2 col-lg-2 col-6">
																	...
																	<select class="custom-select form-control" id="uf_placa" name="uf_placa">
																		<option value="--">--</option>
																		@foreach(App\Venda::estados() as $e)
														...
														<div class="col-xl-12">
															...
															<div class="row align-items-center">
																...
																<div class="form-group col-lg-3 col-md-4 col-sm-6 col-6">
																	...
																	<div class="">
																		<div class="input-group">
																			<input type="text" name="marca" class="form-control" value="@if($venda->frete != null) {{$venda->frete->marca}} @endif" id="marca"/>
																		</div>
																	</div>
																</div>
						...
						<div class="row">
							...
							<div class="col-sm-2 col-lg-4 col-md-6 col-xl-2">
								<div class="form-group col-lg-12 col-md-12 col-sm-12 col-12">
									...
									<div class="">
										<div class="input-group">
											<input type="text" name="desconto" class="form-control" value="{{$venda->desconto > 0 ? $venda->desconto : ''}}" id="desconto"/>
										</div>
									</div>
								</div>
							</div>
							...
							<div class="col-sm-8 col-lg-8 col-md-12 col-xl-6">
								<div class="form-group col-lg-12 col-md-12 col-sm-12 col-12">
									<label class="col-form-label">Nota Referenciada</label>
									<div class="">
										<div class="input-group">
											<input type="number" name="chave_ref" class="form-control" value="{{$venda->chave_ref}}" id="chave_ref"/>
										</div>
									</div>
								</div>
							</div>
