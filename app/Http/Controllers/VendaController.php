...
class VendaController extends Controller
{
	...
	public function salvar(Request $request){
		...
		$result = Venda::create([
			...
			'chave_ref' => $this->sanitizeString($venda['chave_ref']) ?? '',
			'estado' => 'DISPONIVEL',
		...
		foreach ($itens as $i) {
			...
			if(substr($natureza->CFOP_saida_estadual, 0, 1) == '5'){
	...
	public function atualizar(Request $request){
		...
		$venda->chave_ref = $this->sanitizeString($request['chave_ref']) ?? '';
